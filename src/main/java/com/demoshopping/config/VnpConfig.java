...
public class VnpConfig {
    ...
    public static final String vnp_Returnurl = "http://localhost:8080/DemoShopping/payment_result";
    public static final String vnp_TmnCode = "WAM1VZNF";
    public static final String vnp_HashSecret = "BYPFXAJYBWGEYXSCOTUCKYPXQIDCHXYX";
    ...
    public static String hashAllFields(Map<String, String> fields) {
        ...
        return hmacSHA512(vnp_HashSecret, sb.toString().replace(' ', '+'));
    }
