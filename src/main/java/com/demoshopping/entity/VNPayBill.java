...
public class VNPayBill {
	...
	public String toString() {
		return "VNPayBill [vnp_Amount=" + vnp_Amount + ", vnp_BankCode=" + vnp_BankCode + ", vnp_BankTranNo="
				+ vnp_BankTranNo + ", vnp_CardType=" + vnp_CardType + ", vnp_OrderInfo=" + vnp_OrderInfo
				+ ", vnp_PayDate=" + vnp_PayDate + ", vnp_ResponseCode=" + vnp_ResponseCode + ", vnp_TmnCode="
				+ vnp_TmnCode + ", vnp_TransactionNo=" + vnp_TransactionNo + ", vnp_TransactionStatus="
				+ vnp_TransactionStatus + ", vnp_TxnRef=" + vnp_TxnRef + ", confirmCode=" + confirmCode + "]";
	}
